...
class Calendar extends DB_Connect
{
   ...
   /**
     ...
     *
     * @return string the html markup for editing the form
     */
...
FORM_MARKUP;
    ...
    public function processForm()
    {
    	...
    	{
    		/*
    		 * Cast the event ID as an int for security
    		 */
    		$id = (int) $_POST['event_id'];
    		$sql = "UPDATE `events`
    				SET
    ...
    /**
     * Generates markup to display administritive links
     * 
     * @return string markup to display admin links
     */
...
ADMIN_OPTIONS;
	...
	public function confirmdelete($id)
	{
		...
		/*
		 * If the conf form was submitted and the form
		...
		{
			/*
			 * if the deletion is confrimed, remove the event
			 * from the database
			 */
		...
		/*
		 * Idf the confirmation form hasn't been submitted, display it
		 */
		$event = $this->_loadEventById($id);
